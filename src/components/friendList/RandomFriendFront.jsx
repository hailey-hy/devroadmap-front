...
const RandomFriendFront = () => {
  ...
  const goFriend = (friend) => {
    window.localStorage.setItem(
      "friend-nickname",
      friend.match_user_front_nickname
    );
  ...
  if (random2.result === "ok") {
    return (
      <>
        ...
        >
          <Badge pill className="friend-field">
            front
          </Badge>
          <div className="friend-img">
            <img
              src={profileCheck(random2.match_user_front_profile)}
              alt=""
          ...
          <div className="friend-detail-divider">
            ...
            <h5 className="friend-progress">
              {random2.match_user_front_progressrate}%
            </h5>
          </div>
          <div
            class="add-btn-random btn-friend-add"
            id={random2.match_user_front_nickname}
            onClick={(match_user_front_nickname) => {
              accept(match_user_front_nickname);
            }}
          >
            +
          </div>
