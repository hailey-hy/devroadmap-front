...
const RandomFriendBack = () => {
  ...
  const goFriend = (friend) => {
    window.localStorage.setItem(
      "friend-nickname",
      friend.match_user_back_nickname
    );
  ...
  if (random1.result === "ok") {
    return (
      <>
        <div
          className="friend go-friend"
          onClick={() => {
            goFriend(random1);
          }}
        >
          <Badge pill className="friend-field" bg="success">
            back
          </Badge>
          <div className="friend-img">
            <img
              src={profileCheck(random1.match_user_back_profile)}
              alt=""
          ...
          <div className="friend-detail-divider">
            ...
            <h5 className="friend-progress">
              {random1.match_user_back_progressrate}%
            </h5>
          </div>
          <div
            class="add-btn-random btn-friend-add"
            id={random1.match_user_back_nickname}
            onClick={(match_user_back_nickname) => {
              accept(match_user_back_nickname);
            }}
          >
            +
          </div>
