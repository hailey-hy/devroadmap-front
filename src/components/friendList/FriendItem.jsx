...
const FriendItem = ({ record, loading }) => {
  ...
  const handleShow = (e) => {
    // openModal(FRIEND_ALERT.DEL_TITLE, FRIEND_ALERT.DEL_DONE_BODY);
    ...
    return (
      <>
        ...
        <Modal show={show2} onHide={handleClose2}>
          ...
          <Modal.Body>{FRIEND_ALERT.DEL_DONE_BODY}</Modal.Body>
          <Modal.Footer>
