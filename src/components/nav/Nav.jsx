...
import "./nav.css";
import loginCheck from "../../hooks/useLoginCheck";
        ...
        <ul id="nav-content" className={isOpen ? "show-menu" : "hide-menu"}>
          ...
          <div id="container-user">
            ...
            <div id="contianer-user-detail">
              <Badge pill bg={isFront() ? "primary" : "success"}>
                {field}
              </Badge>
              <h5 id="user-nickname">
                {nickname}
          ...
          <Button id="user-delete" variant="warning" onClick={handleShow}>
            {NAV.DELETE}
          </Button>
          ...
          >
            ...
            <Modal.Body>{NAV_ALERT.DEL_BODY}</Modal.Body>
            <Modal.Footer>
              <Button
                variant="secondary"
                onClick={() => {
              ...
              <Button variant="warning" onClick={userWithdraw}>
                {NAV.DELETE}
              </Button>
            </Modal.Footer>
          </Modal>
          ...
          >
            ...
            <Modal.Body>{NAV_ALERT.DEL_DONE_BODY}</Modal.Body>
            <Modal.Footer>
              <Button
                variant="secondary"
                onClick={() => {
